...
import video1 from "../assets/PlatformerVideoDemo.mp4";
import video2 from"../assets/3DEngineDemo.mp4"

function Demos(){
    return(
        <div name="demos" className="bg-[#0a192f] w-full md:h-screen text-gray-300">
                ...
                <div className="pb-8">
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                        ...
                        <div className="shadow-md shadow-[#040c16] rounded-md hover:bg-[#1e67d4] duration-500 p-4 w-fit text-center">
                                ...
                                <p className="text-sm">Being bulit with C++, GLFW, and OpenGL</p>
                        </div>
                    </div>
                </div>
             </div>
